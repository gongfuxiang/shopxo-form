            ...
            <div class="content">
                ...
                <template v-else-if="form.type == 'select'">
                    <div class="flex-col gap-10">
                        <el-select ref="selectRef" v-model="form.form_value" multiple :multiple-limit="1" filterable placeholder="" popper-class="multicolour-select" class="flex-1 border-focus" :style="frame_style + style_container" @change="select_change">
