<template>
    <div class="rendering-area">
        <div class="form-group" :style="common_store.layout_style">
            ...
            <div class="content w">
                <el-input v-model="form.form_value" type="textarea" :style="frame_style + style_container + 'height:100%;'" :minlength="form.is_limit_num == '1' ? form.min_num : ''" :maxlength="form.is_limit_num == '1' ? form.max_num : ''" :autosize="{ minRows: 4, maxRows: 8 }" :placeholder="form.placeholder" @blur="data_check" @change="data_check"></el-input>
