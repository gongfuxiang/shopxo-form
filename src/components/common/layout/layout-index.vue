                    ...
                    <div class="main-overflow w h re">
                        <template v-if="common_store.form_config.type_value == 'free'">
                            <div :style="`margin:0 auto;width: ${ common_store.form_config.custom_width }px;`">
                                ...
                                <div class="re bg-f main-content plug-in-disable oh" :style="`width: ${ common_store.form_config.custom_width }px;height: ${ common_store.form_config.custom_height }px;margin: 0 auto;`">
