        ...
        build: {
            ...
            rollupOptions: {
                output: {
                    ...
                    chunkFileNames: 'static/form_input/js/chunk/[name]-[hash].js',
                    // 自定义 entry chunk 的输出路径和文件名格式
                    entryFileNames: 'static/form_input/js/entry/[name]-[hash].js',
                    //非js文件夹，按照文件类型分类css,png,jpg
                    assetFileNames: 'static/form_input/[ext]/[name]-[hash].[ext]',
                },
            },
        },
    };
